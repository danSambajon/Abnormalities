...
using Abnormalities.Controllers;
using Abnormalities.Data;
using Abnormalities.Models;

namespace Abnormalities.Controllers
{
    public class HomeController : Controller
    {
        ...
        public List<AbnormalityList> Query()
        {
            ...
            .Select(g => new Abnormalities.Models.Fuels0
            {
            ...
            var result2 = result
                .Select((x, index) =>
            new Abnormalities.Models.AbnormalityList
            {
        ...
        [HttpGet]
        public IActionResult GetAbnormalities()
        {
            List<AbnormalityList> resultsList = Query();
        ...
        {
            List<AbnormalityList> resultsList = Query();
            var properties = typeof(AbnormalityList).GetProperties();
